...
Comparison of Supervised Learning Alogrithms in Binary Classification Tasks. The purpose of this project was purely educational. It proved to be extremely useful, as I learnt the ins and outs of different models. My biggest take away is the idea that no one model completely trumps others. When switching from one model to the other, regardless of the domain, it is a give-and-take type situation. 
